        ...
        <div className={styles.MainSection3}>
                ...
                <div className={styles.boxgroup}>
                    ...
                    <div className={styles.box1}>
                        ...
                        <div  className={styles.inbox4}><p className={styles.text}>팀</p><p className={styles.conf2}>확인 &gt;</p></div>
                    </div>
                    <div className={styles.box1}>
                        <div  className={styles.inbox3}><img className={styles.img}src={MainSection3_3}/></div>
                        <div  className={styles.inbox4}><p className={styles.text}>선수</p><p className={styles.conf3}>확인 &gt;</p></div>
                    </div>
                </div>
